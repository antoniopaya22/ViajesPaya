...
addJapanPlace({
  ...
  stats: [
    {value:'869', label:'año de origen del Gion Matsuri', icon:'⛩️'},
    {value:'1654', label:'reconstrucción del Honden actual', icon:'🏛️'},
    {value:'300', label:'farolillos alrededor del Buden', icon:'🏮'}
  ],
  blocks: [
    ...
    {type:'heading', text:'Entrada y primeros santuarios', icon:'⛩️'},
    ...
    {type:'heading', text:'El patio central', icon:'🏛️'},
    ...
    {type:'heading', text:'Alrededor del santuario', icon:'🚶'},

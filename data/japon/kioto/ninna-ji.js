...
addJapanPlace({
  ...
  stats: [
    {value:'888', label:'año de fundación, por el emperador Uda'},
    {value:'36 m', label:'altura de la pagoda de cinco pisos'},
    {value:'200', label:'cerezos Omuro Zakura de floración tardía'}
  ],
  blocks: [

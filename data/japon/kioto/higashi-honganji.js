...
addJapanPlace({
  ...
  stats: [
    {value:'1602', label:'fundación, al dividirse el budismo Jōdo Shinshū'},
    {value:'76 m', label:'longitud del salón Goeidō'},
    {value:'4', label:'incendios sufridos durante el periodo Edo'}
  ],
  blocks: [
    ...
    {type:'heading', text:'Cuatro incendios y una reconstrucción con cabello'},

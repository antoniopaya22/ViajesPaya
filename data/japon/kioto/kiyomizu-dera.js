...
addJapanPlace({
  slug: 'kiyomizu-dera', city: 'kioto', zone: 'higashiyama-sur', name: 'Kiyomizu-dera', category: 'Templo', reviewed: '2026-09',
  ...
  blocks: [
    ...
    {type:'stop', title:'Honten, Haiden y otros rincones de Jishu', text:[
      'Entre las dos piedras del amor se levantan los salones principales del santuario, Honten y Haiden, ambos declarados Bienes de Importancia Cultural; en el techo puede verse una pintura de un dragón obra del pintor clásico Kanō Motonobu. A su lado, la sencilla puerta Sō-mon imita en madera oscura la forma de un torii.',
      'Detrás, el pequeño santuario de Okage Myōjin, protector de las mujeres, guarda una leyenda del periodo Edo: se dice que algunas acudían aquí de madrugada a clavar muñecas de paja en los cedros cercanos para maldecir a sus rivales, y todavía pueden verse marcas en la corteza. Muy cerca, la estatua de Mizukake Jizō se acompaña de cuatro cazos —para suerte en los exámenes, en el amor, en general o para alejar a los malos espíritus— con los que se le echa agua por encima para pedir el deseo correspondiente.'
    ]},

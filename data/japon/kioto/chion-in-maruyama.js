...
addJapanPlace({
  ...
  stats: [
    {value:'24 m', label:'altura de la puerta Sanmon, la mayor de Japón'},
    {value:'106', label:'edificios repartidos por la ladera'},
    {value:'7 t', label:'peso de la gran campana Daishōrō'},
    {value:'680+', label:'cerezos en el parque Maruyama'}
  ],
  blocks: [
    ...
    {type:'heading', text:'El templo Chion-in'},
    ...
    {type:'heading', text:'El parque Maruyama'},

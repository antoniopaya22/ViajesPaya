...
addJapanPlace({
  slug: 'ginkaku-ji', city: 'kioto', zone: 'higashiyama-norte', name: 'Ginkaku-ji', category: 'Templo y jardín', reviewed: '2026-09',
  ...
  price: '500 ¥ adulto',
  stats: [
    {value:'1474', label:'año de construcción, como retiro del shōgun', icon:'pagoda'},
    {value:'0', label:'láminas de plata: nunca se llegaron a instalar', icon:'scroll'},
    {value:'2', label:'edificios originales que sobreviven intactos', icon:'pagoda'}
  ],
  blocks: [

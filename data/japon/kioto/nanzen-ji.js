...
addJapanPlace({
  ...
  stats: [
    {value:'1291', label:'fundación, sobre el palacio de verano imperial'},
    {value:'22 m', label:'altura de la puerta San-mon'},
    {value:'93 m', label:'longitud del acueducto Suirokaku'}
  ],
  blocks: [

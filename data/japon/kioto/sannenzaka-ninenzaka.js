...
addJapanPlace({
  ...
  stats: [
    {value:'2', label:'cuestas escalonadas del periodo Edo'},
    {value:'24 m', label:'de altura de la pagoda Yasaka, al fondo'},
    {value:'1', label:'Starbucks dentro de una casa tradicional'}
  ],
  blocks: [

...
addJapanPlace({
  ...
  blocks: [
    ...
    {type:'stop', title:'El barrio de antigüedades de Ohto', text:[
      'El paseo por Gion suele arrancar en la salida 3 de la estación de Sanjō, bajando hacia la calle Wakamatsu y girando a la calle Yamato-Ōji, donde comienza la zona conocida como Ohto, llena de tiendas de antigüedades, arte y textiles. En ella destacan la tienda de telas Nakamura Chingireya, especializada en tejidos sake-ori de los periodos Edo y Meiji, y la tienda Konjaku Nishimura, centrada en textiles teñidos de finales de Edo y comienzos de Shōwa.'
    ]},
    {type:'stop', title:'Shirakawa', text:[
      'El distrito de Shirakawa, junto al riachuelo del mismo nombre, reúne algunas de las casas de té más fotogénicas de Gion, como la okiya Ninben o las ochaya Okakai, Fusanoya y Masanoya. Los farolillos de papel que cuelgan de sus puertas llevan el blasón de Gion Kōbu: un círculo hecho con un dango, la bola dulce de pasta de arroz. Cerca está el memorial al poeta Yoshii Isamu y el ryokan Shiraume, antigua ochaya desde 1949 cuyo puente de acceso está flanqueado por dos ciruelos centenarios.',
      'En esta misma zona se encuentra el santuario Tatsumi, que apareció en la serie Makanai: la cocinera de las maiko, y el puente Tatsumi justo enfrente. Cruzando el puente Shimbashi se llega al tradicional ryokan Shinmonso, donde se puede reservar una cena kaiseki con espectáculo de danza de maikos y fotos con ellas: una buena primera toma de contacto si nunca se ha visto a una maiko de cerca.'
    ]},
    ...
    {type:'stop', title:'Tiendas tradicionales de Gion', text:[
      ...
      'Ya cerca del cruce con la calle Higashi-Ōji hay otras tres tiendas centenarias: Miura Shomei, dedicada a farolillos y lámparas de papel hechos a mano en exclusiva para la tienda; Kasagen, la tienda de paraguas y parasoles tradicionales más antigua de Kioto, vendiendo desde 1861; y Kazura-sei, que empezó en 1865 como peluquería para actores y bailarines y hoy vende kanzashi y adornos de pelo de concha de tortuga, perlas y madera.'
    ]},
    ...
    {type:'stop', title:'Un hanamachi más tranquilo', text:[
      ...
      'El paseo suele empezar en la salida 5 de la estación Gion-Shijō (línea Keihan), en la esquina de la calle Miyagawa junto a un pequeño parque municipal. Tanto esta calle como sus perpendiculares están llenas de farolillos de papel con el blasón de Miyagawa-chō: tres círculos conectados que simbolizan la unidad de los templos, el pueblo y las casas de té.'
    ]},
    {type:'stop', title:'Casas de té y teatro del barrio', text:[
      'Frente al parque municipal, al comienzo del paseo, está la antigua casa de té Hanagumo, hoy convertida en bar. Un poco más adelante, la casa de té Hanafusa alberga el local de maiko-henshin Hanagiku, donde es posible transformarse en maiko (o al menos parecerlo) durante unas horas.',
      'Merece la pena no perderse la hilera de casas de té y de geishas de la zona de Miyagawasuji 4-chōme, ni la casa de té Takayoshi, escondida en una callejuela al norte de Miyagawasuji 6-chōme. El teatro de Miyagawa-chō, en Shimoyanagichō, es donde ensayan y actúan las maikos y geishas del barrio, y el santuario Ebisu es el santuario al que acuden habitualmente. Muy cerca, antes de entrar en Gion, se puede visitar también el gran complejo del templo Kennin-ji, el pequeño templo Zenkyō-an y el curioso santuario Yasui Konpira-gu.'
    ]}
  ],
